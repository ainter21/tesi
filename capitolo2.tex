...
\subsubsection{Newscast - non completo}
...
\begin{itemize}
    \item \textbf{selectNeighbor()}: sceglie un noda dalla vista parziale
    \item \textbf{prepareRequest()} e \textbf{prepareReply()}: ritorna la vista più il proprio indirizzo con il timestamp aggiornato
    \item \textbf{merge()}: ritorna i più recenti collegamenti, scelti tra la propria vista e quella inviata dall’altro nodo
\end{itemize}
...
\subsubsection{Riduzione dei fasi positivi}
